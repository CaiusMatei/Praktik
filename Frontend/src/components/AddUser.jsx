...
export default function AddUser() {
    ...
    return (
        <div className="w-full flex items-center justify-between">
            <div className=" w-[709px] h-[673px] m-[59px] rounded-[12px]  ">
                ...
                >
                    <div className="flex justify-between">
                        ...
                        >
                            ...
                            <input
                                type="text"
                                placeholder="Eden Kirel "
                                value={fullName}
                                onChange={(e) => setFullName(e.target.value)}
                                className="h-[44px] rounded-[9px] border-[1px] border-black  font-[400] font-din text-[20px] px-4   outline-none placeholder-black  "
                            />
                        </label>
                        <label
                            htmlFor=""
                    ...
                    <div className=" flex justify-between">
                        ...
                        >
                            ...
                            <div className=" flex items-center justify-between h-[44px] rounded-[9px] border-[1px] border-black  font-[400] font-din text-[20px] px-4   outline-none placeholder-black">
                                <input
                                    type="email"
                                    placeholder="Eden.kirel77@chas.se"
                                    value={email1}
            ...
            <div className=" flex flex-col   mb-20 w-[450px]   ">
                <button
                    type="button"
                    className="font-[700] font-din_regular text-[23px] leading-[36px] bg-[#e9e9e9] w-[339px] h-[87px]  rounded-[7px] mb-[9px] text-black  cursor-default"
                >
