    ...
    public partial class addedmodels : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventEducations", x => new { x.EventId, x.EducationId });
                    table.ForeignKey(
                        name: "FK_EventEducations_Educations_EducationId",
                        column: x => x.EducationId,
                        principalTable: "Educations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventEducations_Events_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventTeachers", x => new { x.EventId, x.TeacherId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventEducations_EducationId",
                table: "EventEducations",
                column: "EducationId");
