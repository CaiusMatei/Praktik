    ...
    render() {
        return (
            <div className="bg-inherit flex flex-col sm:flex-row gap-4 items-center justify-between px-2 text-black">
                <div className="flex flex-col items-center">
                    ...
                    <button
                        ...
                        className="mt-2 bg-blue-500 text-white py-1 px-2 text-sm rounded-md hover:bg-blue-600 transition-colors duration-300">
                        Return to Home Page
                    </button>
                </div>
                ...
                <form className="flex flex-col flex-grow w-72 sm:w-96 p-4 rounded-md bg-gray-50 shadow-md" onSubmit={this.handleLogin}>
                    ...
                    <div className="relative mb-4 z-0">
                        <input type="text" id="username" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-black
            appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                        ...
                        <label htmlFor="username" className="absolute text-sm text-gray-700 dark:text-gray-600 duration-300 transform -translate-y-6 scale-75 top-3 -z-10
            ...
            peer-focus:scale-75 peer-focus:-translate-y-6 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto"><i className="fas fa-user text-black"></i> Användarnamn</label>
                        ...
                        <p id="username_success_help" className="mt-2 text-xs text-green-600 dark:text-green-400">{this.state.successMessage}</p>
                        <p id="username_error_help" className="mt-2 text-xs text-red-600 dark:text-red-400">{this.state.errorMessage}</p>
                    </div>
                    <div className="relative mb-4 z-0">
                        <input type="password" id="password" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-black
            appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />

                        <label htmlFor="password" className="absolute text-sm text-gray-700 dark:text-gray-600 duration-300 transform -translate-y-6 scale-75 top-3 -z-10
            origin-[0] peer-focus:start-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0
            peer-focus:scale-75 peer-focus:-translate-y-6 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto"><i className="fas fa-lock text-black"></i> Lösenord</label>
                        ...
                        <p id="password_success_help" className="mt-2 text-xs text-green-600 dark:text-green-400">{this.state.successMessage}</p>
                        <p id="password_error_help" className="mt-2 text-xs text-red-600 dark:text-red-400">{this.state.errorMessage}</p>
                    </div>
                    ...
                    <p className="text-right pt-2">
                        <button className="text-gray-500 cursor-pointer hover:border-b-2 border-color-gray-700" onClick={this.handleForgotPassword}>
                            Forgot Password?
                        </button>
                    </p>
                </form>
