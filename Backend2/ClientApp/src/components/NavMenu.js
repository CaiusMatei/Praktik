  ...
  render() {
    return (
      <header className="mb-4">
        <nav className="bg-transparent border-b-0 border-color-gray">
            ...
            <div className="relative flex items-center justify-between h-16">
              <div className="flex items-center flex-shrink-0 text-black text-xl">
                <button onClick={this.toggleNavbar} className="text-black">
                  <div className="flex flex-1 w-12 sm:w-16">
                    <img
          ...
          <div className={`${this.state.collapsed ? 'hidden' : ''} sm:hidden`}>
            <div className="flex flex-col gap-4 px-4 pb-4 pt-2">
              <Link to="/" className="block text-black bg-slate-200 rounded px-4 py-3" onClick={this.toggleNavbar}>
                <i className="fas fa-home"></i> Home</Link>
              <Link to="/login" className="block text-black bg-slate-200 rounded px-4 py-3" onClick={this.toggleNavbar}>
                <i className="fas fa-lock"></i> Login</Link>
