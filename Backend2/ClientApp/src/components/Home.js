      ...
      <div className="bg-inherit flex flex-col flex-wrap gap-4 items-center justify-center px-2 text-black h-full">
        ...
        <form class="flex flex-2 items-center max-w-sm mx-auto">
          ...
          <div class="relative w-full">
            ...
            <input type="text" id="simple-search" class="bg-transparent border border-slate-50 text-gray-900 text-sm rounded-lg
            ...
            dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Sök Kurs..." required />
          </div>
